		...
		<h1 style="color:#fff;" class="typewriters p-3"><b>Customer Details</b></h1>
			<div class="col-lg-12 m-0 p-0 table-responsive ">
             ...
             ?>
                ...
                <td><a href="task.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn justify-content-center" style="background-color : #fff; color:#114566;">Transfer Money</a></td> 
                    </tr>
            </tr>
